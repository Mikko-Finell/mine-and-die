...
| Incremental patch payloads drop baseline entities | Critical   | 🟢 Done  | Repro: kill goblin; NPC/effect patches arrive without snapshot arrays, so client now seeds patch baseline from prior state. |
