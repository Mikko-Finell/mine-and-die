...
func TestRunGeneratesEffectCatalogModule(t *testing.T) {
  ...
  },
  {
	...
	hashGoPath := filepath.Join(tempDir, "out", "catalog_hash.go")
	...
	goData, err := os.ReadFile(hashGoPath)
	if err != nil {
		t.Fatalf("failed to read generated Go hash: %v", err)
	}
	expectedGo := fmt.Sprintf("// Code generated by effectsgen. DO NOT EDIT.\n\npackage contract\n\nconst EffectCatalogHash = \"%s\"\n", hashHex)
	if string(goData) != expectedGo {
		t.Fatalf("unexpected Go hash output:\n%s\nwant:\n%s", goData, expectedGo)
	}

	tsData, err := os.ReadFile(hashTSPath)
	if err != nil {
		t.Fatalf("failed to read generated TS hash: %v", err)
	}
	expectedTS := fmt.Sprintf("// Code generated by effectsgen. DO NOT EDIT.\n\nexport const effectCatalogHash = \"%s\" as const;\n", hashHex)
	if string(tsData) != expectedTS {
		t.Fatalf("unexpected TS hash output:\n%s\nwant:\n%s", tsData, expectedTS)
	}
