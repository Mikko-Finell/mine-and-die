...
func (h *Hub) Join() joinResponse {
	...
	return joinResponse{ID: playerID, Players: players, NPCs: npcs, Obstacles: obstacles, Effects: effects, Config: cfg, WorldWidth: worldWidth, WorldHeight: worldHeight}
}
