...
func (h *Hub) broadcastState(players []Player, npcs []NPC, effects []Effect, triggers []EffectTrigger, groundItems []GroundItem) {
	...
	for _, marker := range []struct {
		...
		{label: "blood-splatter", needle: []byte("\"type\":\"blood-splatter\"")},
		{label: "fire", needle: []byte("\"type\":\"fire\"")},
		{label: "fireball", needle: []byte("\"type\":\"fireball\"")},
		{label: "melee-swing", needle: []byte("\"type\":\"melee-swing\"")},
	} {
